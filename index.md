...
These examples were obtained using the end-to-end workflow of the app described in the paper by recording a voice prompt and generating the corresponding sound.
